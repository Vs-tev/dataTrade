<div {{$attributes->merge(['class' => 'modal'])}} id="modal_edit" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <form {{$attributes->merge(['class' => 'modal-content'])}} action="/action_page.php">
            <div {{$attributes->merge(['class' => 'modal-header'])}}>
                <h5 {{$attributes->merge(['class' => 'modal-title'])}}>Edit {{$item}}</h5>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" {{$attributes->merge(['class' => 'btn btn-primary'])}}>Save</button>
            </div>
        </form>
    </div>
</div>
