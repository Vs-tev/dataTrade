<template>
    ...
    <div class="m-auto p-3 pm-0 ">
        <div class="text-center mb-5">
            <h2 class="uppercase font-weight-bolder primary">dataTrade
            </h2>
        </div>
        <div class="py-4 ">
        ...
        <div class="form-group mb-5">
            ...
            <input
                ...
                <p
                    class="error-output"
                    v-if="value.errors.has('name')"
                    v-text="value.errors.get('name')"></p>
            </div>
            <div class="form-group mb-5">
                ...
                <input
                    type="text"
                    class="form-control auth-input"
                    v-model="value.start_equity"
                    placeholder="Enter start equity">
                    <p
                        class="error-output"
                        v-if="value.errors.has('start_equity')"
                        v-text="value.errors.get('start_equity')"></p>
                </div>
                <div class="form-group row mx-0 mb-5">
                    <div class="col-6 pl-0">
                        <label class="font-lg font-weight-bold dark">Currency</label>
                        <select
                            class="form-control auth-input auth-input-w-50"
                    ...
                    <div class="form-group col-6 pr-1">
                        ...
                        <p
                            class="error-output"
                            v-if="value.errors.has('started_at')"
                            v-text="value.errors.get('started_at')"></p>
                    </div>
                </div>
