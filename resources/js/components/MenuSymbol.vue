<template>
    <form class="dropdown-menu symbol-menu w-100 pb-0">
        <div class="p-0">
            <div
                class="d-flex justify-content-between border-bottom align-items-center pb-3 w-100">
                <div class="form-group align-items-center pl-2 ">
                    <input
                        type="text"
                        @keyup="getSymbols(type)"
                        v-model="search_symbol"
                        name="text"
                        placeholder="Search symbol"
                        class="form-control font-lg font-weight-500 text-uppercase search-input input-focus-none border-0">
                ...
                <div class="px-0">
                    <ul class="nav nav-tabs  border-0 mb-2 px-4 " role="tablist">
                        <li class="nav-item" @click="getSymbols('forex')">
                            <a
                                href="#forex"
                                class="nav-link active font-lg"
                                role="tab"
                                data-toggle="tab"
                                aria-selected="true">Forex</a>
                        </li>
                        ...
                        <div id="forex" class="tab-pane active" role="tabpanel">
                            <ul class="list-group list-group-flush">
                                <li
                                    ...
                                    :key="symbol.id">
                                    <div
                                        class="d-flex justify-content-between pointer p-3"
                                        @click="setSymbol(symbol.symbol)">
                                ...
                                <li
                                    ...
                                    <h4 class="font-500 text-muted">No Symbol Found</h4>
                                </li>
                            </ul>
                        </div>
                    </div>
...
export default {
  ...
  data() {
    return { type: "forex", search_symbol: "", symbols: [] };
  },
